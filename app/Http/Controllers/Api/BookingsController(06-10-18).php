            ...
            if(empty($checkBlock))
            {
                ...
                if($insertdata > 0)
                {
                    if($apoinment_mail)
                    {
                        ...
                        $service_start_time = date('l d, Y h:m A',$strto_start_time);
                        ...
                        $client_email_data['email_data'] = "An appointment has been successfully booked.";
                        ...
                        //$stuff_email_data['email_data'] = "An appointment has been successfully booked.";
                        $this->sendmail(8,$staff_email,$client_email_data);
