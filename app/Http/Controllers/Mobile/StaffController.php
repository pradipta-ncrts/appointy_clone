...
class StaffController extends ApiController {
	...
	public function staff_list(Request $data,$type="")
	{
		...
		return view('mobile.staff.staff-list');
	}

	public function add_staff(Request $data,$type="")
	{
		$authdata = $this->website_login_checked();
		if((empty($authdata['user_no']) || ($authdata['user_no']<=0)) || (empty($authdata['user_request_key'])))
		{
		...
		return view('mobile.staff.add-staff');
	}
