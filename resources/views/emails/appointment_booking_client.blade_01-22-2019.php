...
<div style="max-width:650px; margin:20px auto; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif">
    ...
    <div style="padding:20px; background: #FFF; border-radius:0 0 8px 8px ;">
            ...
            Hi <?php echo ucwords($client_name);?>,<br><br>
            You have a confirmed booking. <br><br>
            <span style="color:#888;">What:</span> <?php echo ucwords($service_name);?><br><br>
            <span style="color:#888;">Who:</span> <?php echo ucwords($staff_name);?><br><br>
            <span style="color:#888;">When:</span> <?php echo $service_start_time;?><br> <br>
            <!--<span style="color:#888;">Where:</span> Coffee Shop<br><br>
            <span style="color:#888;">Jane's Local Time:</span> India, Sri Lanka Time<br><br>-->
            For further discussions, email <?php echo ucwords($staff_name);?> at <a href="<?php echo $staff_email;?>"><?php echo $staff_email;?></a><br><br>
            If you wish to make changes, please go to: <a href="#">www.squeedr.com</a><br><br>
            <i>- Squeedr, Your friendly Assistant</i>
        ...
        <div style="text-align:center;">
            <a href="<?php echo $reschedule_url;?>" style="border-radius: 4px;background-color: #2ba2da; color: #FFF; padding: 10px 25px; width:150px; display:inline-block; text-decoration: none;">Re-schedule</a>  &nbsp;
            <a href="<?php echo $cancel_url;?>" style="border-radius: 4px;background-color: #888;color: #FFF; padding: 6px 25px; text-decoration: none;padding: 10px 25px; width:150px; display: inline-block; ">Cancel</a>
        </div>
    </div>
