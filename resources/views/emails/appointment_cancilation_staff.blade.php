...
<div style="max-width:650px; margin:20px auto; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif">
   ...
   Hi <?=$staff_name;?>,<br><br>
  Your appointment for <?=$service_name;?> with <?=$client_name;?> has been cancelled.     
  <br><br>                                                 
  <span style="color:#888;">Sheduled Time :</span> <?=$sheduled_time;?>
  <br><br>
  <span style="color:#888;">Your reason for cancellation:</span> Not Available 
  <br><br> 
  If you wish to make a new appointment, please go to <Sam’s Squeedr Page Link>.     <br><br>
  Squeedr is for Everyone! Try it for free today.
