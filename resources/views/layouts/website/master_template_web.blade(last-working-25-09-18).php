...
<html>
   ...
   <body>
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              ...
                              <div class="form-group nomarging color-b selectStaff" >
                                 <select class="" data-show-subtext="true" data-live-search="true" name="staff" id="staff"> 
      ...
      <div class="modal fade" id="myModalcalendarappoinment" role="dialog">
         <div class="modal-dialog add-pop">
            <!-- Modal content--> 
            <div class="modal-content new-modalcustm">
                <form name="calendar_appointmentm_form" id="calendar_appointmentm_form" method="post" action="{{ url('api/add_appoinment') }}" enctype="multipart/form-data">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button> 
                        <h4 class="modal-title"> Add Appointments</h4>
                    </div>
                    <div class="modal-body clr-modalbdy">
                            <div class="row">
                                ...
                                <div class="form-group">
                                    <div class="input-group"> <span class="input-group-addon"><i class="fa fa-users"></i></span> 
                                        <div class="form-group nomarging color-b" >
                                            <select class="selectpicker" data-show-subtext="true" data-live-search="true" name="client" id="calendar_client"> 
                                            <option value="">Select Client</option>
                                            <?php
                                            foreach ($clients_list['client_list'] as $key => $cli)
                                            {
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-cog"></i></span> 
                                    <div class="form-group nomarging color-b" >
                                        <select class="selectpicker" data-show-subtext="true" data-live-search="true" name="appoinment_service" id="calendar_appoinment_service"> 
                                            <option value="">Select Service</option>
                                            <?php
                                            foreach ($services_list['service_list'] as $key => $serv)
                                            {
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span> 
                                    <div class="form-group nomarging color-b" >
                                        <select class="selectpicker" data-show-subtext="true" data-live-search="true" name="staff" id="calendar_staff"> 
                                            <option value="">Select Staff</option>
                                            <?php
                                            foreach ($stuffs_list['stuff_list'] as $key => $stf)
                                            {
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                <div class="input-group"> <span class="input-group-addon"><i class="fa fa-calendar"></i></span> <input id="calendar_date" type="date" class="form-control" min="<?php echo date("Y-m-d", time() + 86400); ?>" name="date" placeholder="Date"> </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                <div class="input-group"> <span class="input-group-addon"><i class="fa fa-calendar"></i></span> <input id="calendar_appointmenttime" type="time" class="form-control" min="07:00:00" max="21:00:00" name="appointmenttime" placeholder="Time"> </div>
                                </div>
                            </div>
                        </div>
                        <!-- <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                <div class="input-group textarea-md"> <span class="input-group-addon"><i class="fa fa-file"></i></span>
                                    <textarea style="width: 100%" name="appoinment_note" id="calendar_appoinment_note" placeholder="Note"></textarea>
                                </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        <div class="col-md-12 text-center"> 
                            <input type="submit" id="" class="btn btn-primary butt-next" style="margin: 0px auto 0; width: 150px; display: block" name="submit" value="submit">
                            <!-- <button type="button" >Submit</button> --> </div>
                    </div>
                </form>
            </div>
