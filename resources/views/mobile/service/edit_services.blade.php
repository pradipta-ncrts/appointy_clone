...
<script>
               ...
               success: function(response) {
                   ...
                   if(response.response_status==1)
                   {
                       if(response.service_id != ''){
                           var url = "{{url('/mobile/edit_service/'.$request_data)}}";
   ...
   $('.answertype').click(function(e){
        ...
        {
            $.ajax({
                url: baseUrl2+"/api/invitee-question-details", 
                type: "POST", 
                data: data, 
                dataType: "json",
                success: function(response) 
    ...
    $("#delete_question").click(function (event) {
        ...
        closeOnCancel: true
            ...
            if (isConfirm){
                ...
                data.push({name:'invitee_question_id', value:invitee_question_id});
                $.ajax({
                    url: baseUrl2+"/api/delete-invitee-question", 
                    type: "POST", 
                    data: data, 
                    dataType: "json",
                    success: function(response) 
    ...
    $(document).ready(function(){
        ...
        $("#apply_all").click(function(){
            ...
            console.log(data);
            $.ajax({
                url: baseUrl2+"/api/update-service-availability", 
                type: "POST",
                data:data ,
                dataType: "json",
                success: function(response) {
