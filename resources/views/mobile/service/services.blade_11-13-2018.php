      ...
      <div class="upr-rgtsec">
         <div class="col-md-6">
            <ul class="tab-menu  nav nav-tabs">
               ...
               <li class=""><a class="" href="">Template</a></li>
            </ul>
         </div>
         <div class="col-sm-6">
            &nbsp;
   ...
   <div class="leftpan">
      <div class="left-menu">
         <ul>
            ...
            {
            ?>
            <li class="<?=Request::segment(3) == $value->category_id ? 'active' : ''; ?>"><a class="<?=Request::segment(3) == $value->category_id ? 'active' : ''; ?>" id="" href="{{ url('services') }}/{{ Request::segment(2) }}/<?=$value->category_id;?>"><?=$value->cat;?></a></li>
            <?php
            }
            ?>
         </ul>
            ...
            <div class="mobSevices lnk">
               <ul>
                  <li onclick="showUl(this);">
                     <a href="#"> My Squeeder Link <i class="fa fa-caret-down"></i></a>
                     <ul>
            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="form-group">
                     <div class="niceditor"> <textarea style="width: 100%" id="embed_code" placeholder=""></textarea> </div>
                  </div>
               </div>
            </div>
         </div>
         <div class="modal-footer">
            <div class="col-md-12 text-center"> <input id="copy-embed-link" type="submit" value="copy" class="btn btn-primary butt-next" style="margin: 0px auto 0; width: 150px; display: block"> </div>
         </div>
      </div>
   </div>
</div>
