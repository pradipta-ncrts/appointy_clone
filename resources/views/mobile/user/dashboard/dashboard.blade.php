    ...
    <div class="menuoverlay">
        <div class="sideNavbar sideToggle">
            <div class="profileMenuImg">
                <img src="{{asset('public/assets/mobile/images/profilepicmobile.jpg')}}" />
                <span>Esther F. Gladden</span>
            </div>
            <ul>
                <li><a><img src="{{asset('public/assets/mobile/images/sidenav/bookings.png')}}" /> <span>Bookings</span> </a> </li>
                <li><a><img src="{{asset('public/assets/mobile/images/sidenav/review.png')}}" /> <span>Reviews</span> </a> </li>
                <li><a><img src="{{asset('public/assets/mobile/images/sidenav/customers.png')}}" /> <span>Customers</span> </a> </li>
                <li><a><img src="{{asset('public/assets/mobile/images/sidenav/feedback.png')}}" /> <span>Feedback</span> </a> </li>
                <li><a><img src="{{asset('public/assets/mobile/images/sidenav/customers.png')}}" /> <span>Customers</span> </a> </li>
