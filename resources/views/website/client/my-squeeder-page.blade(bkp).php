                     ...
                     <div class="banner-top">
                        <div class="img-banner-parent">
                           <div class="img-banner">
                              ...
                              <div class="blackbox">
                                 <div class="lefttext">
                                    <h6><?=$user_details->user_type==1 ? $user_details->name :  $user_details->business_name;?><br/> <span><?=$user_details->prof ? $user_details->prof : "No data found";?></span> </h6>
                                 </div>
                     ...
                     <div class="staffs">
                        <div class="staffsinside">
                           <div class="prof">
                              ...
                              <div class="prof-cont">
                                 <h3>Presentation</h3>
                                 <p><?=$user_details->presentation ? $user_details->presentation : "No data found";?> <!-- <a href="#">more</a> --> </p>
                              </div>
                           </div>
                        </div>
                     </div>
                                 ...
                                 <div class="headRow mobileappointed clearfix" id="row2">
                                    ...
                                    <div class="appointment mobSevices col-sm-4">
                                       <div class="pull-left">
                                          ...
                                          <span><?=$details->duration;?> min <label><?=$details->currency;?> <?=$details->duration ? $details->cost : '';?></label> </span> 
                                       </div>
                                       <div class="pull-right"><?=$details->cat;?></div>
                                    </div>
                                    <?php
                                    }
                                    ?>
                           ...
                           <div class="prof">
                              ...
                              <div class="prof-cont">
                                 <div class=" col-md-4">
                                    ...
                                    <p><img src="{{asset('public/assets/website/images/profile-icon-location1.png')}}" /> <?=$user_details->business_location ? $user_details->business_location : "No data found";?> </p>
                                    <h5>Transport</h5>
                                    <p><?=$user_details->transport ? $user_details->transport : "No data found";?> </p>
                                    <h5>Parking</h5>
                                    <p><?=$user_details->parking ? $user_details->parking : "No data found";?> </p>
                                    <!-- <h5>Useful information</h5>
                                    <p>Ground floor, Handicap access </p> -->
                                 </div>
                                 <div class=" col-md-4">
                                    <h3>Contacts</h3>
                                    <div class="inf"> <img src="{{asset('public/assets/website/images/profile-icon-email.png')}}" /> <?=$user_details->email ? $user_details->email : "No data found";?></div>
                                    <div class="inf"> <img src="{{asset('public/assets/website/images/profile-icon-phone1.png')}}" /> <?=$user_details->mobile ? $user_details->mobile : "No data found";?> </div>
                                    ...
                                    <div class=" flex break30px">
                                       <div class="prof-cont">
                                          <h3>Payment mode</h3>
                                          <p><?=$user_details->payment_mode ? $user_details->payment_mode : "No data found";?></p>
                                       </div>
                                    </div>
                                 </div>
                                 <div class=" col-md-4 socials">
                                    <h3>Social Medias</h3>
                                    <div class="inf"> 
                                       <a target="_blank" href="<?=$user_details->facebook_link ? $user_details->facebook_link : "";?>" class="fa fa-facebook-official"></a>
                                       <a target="_blank" href="<?=$user_details->twitter_link ? $user_details->twitter_link : '';?>" class="fa fa-twitter-square"></a> 
                                       <a target="_blank" href="<?=$user_details->linked_in_link ? $user_details->linked_in_link : '';?>" class="fa fa-instagram"></a> 
                                    </div>
                                 </div>
                              </div>
                           </div>
