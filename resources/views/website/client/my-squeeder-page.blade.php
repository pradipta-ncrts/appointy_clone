...
<html>
   <head>
      ...
      <style>
         ...
         .banner-top{position:fixed;z-index:5;margin-top:0;min-height:340px;}
         .white-bx{background:#fff;padding:10px 0;width:100%;float:left;}
      </style>
   </head>
   <body>
               ...
               <div class="row">
                  <div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1">
                     <div class="profileInside">
                        <div class="white-bx"></div>
                        <div class="banner-top">
                           <div class="mysquder-fxd">
                              ...
                              <div class="dropdown pull-right mysl-drp">
                                 ...
                                 <ul class="dropdown-menu">
                                    ...
                                    <?php
                                       ...
                                       } else { echo "<h2>No service found!</h2>"; }
                                    ?>
                                 </ul>
                              </div>
                              <?php
                                 if($user_details->user_type == 1){                                 
                                     $image =  $user_details->profile_perosonal_image ? 'profile_perosonal_image/'.$user_details->profile_perosonal_image : asset('public/assets/website/images/user-img.png');                                 
                                 } else {                                 
                                     $image = $user_details->profile_image ? 'profile_image/'.$user_details->profile_image : asset('public/assets/website/images/user-img.png');                                 
                                 }

                                 if($user_details->profile_perosonal_image || $user_details->profile_image)                                 
                                 {                                
                                    ?>
                              <img src="{{asset('public/image/')}}/<?=$image;?>" class="profilepic" height="170"/>
                              <?php 
                                 }                                 
                                 else                                
                                 {                                
                                 ?>
                              <img src="{{asset('public/assets/website/images/noimage1.png')}}" class="profilepic"  height="170"/>
                              <?php
                                 }
                              ?>
                              ...
                              <div class="staffsinside">
                                 ...
                                 <div class="owl-carousel owl-theme owl-custom">
                                    <?php
                                       ...
                                       {
                                    ?>  
                                    <a href="{{url('/client/view-staffs/'.$value->username)}}">
                                       <div class="item">
                                          <?php
      ...
      <script>
         ...
         var scrollToPosition = $('#service_section').offset().top;
         $('html, body').animate({
           scrollTop: scrollToPosition -340}, 
           'slow');
         });
                 
         
         $("#presentation_link").click(function() {   
          var scrollToPosition = $('#presentation_section').offset().top;      
             $('html,body').animate({
                 scrollTop: scrollToPosition -340},
                 'slow');
         });
         ...
         $("#expertise_link").click(function() {
          var scrollToPosition = $('#expertise_section').offset().top;
             $('html,body').animate({
                 scrollTop: scrollToPosition -340},
                 'slow');
         });
         ...
         $("#contact_link").click(function() {
          var scrollToPosition = $('#contact_section').offset().top;
             $('html,body').animate({
                 scrollTop: scrollToPosition -340},
                 'slow');
         });
