                  ...
                  <div class="pay cust-box">
                     ...
                     <div id="collapse2" class="panel-collapse collapse ">
                        <div class="">
                           ...
                           <form class="form-horizontal" id="add-pre-payment-charege" method="post" action="{{ url('api/pre_payment_charges') }}">
                              <table>
                                 <tr>
                                    <td>Charge</td>
                                    <td>
                                       <div class="form-group">
                                          <input type="text" class="form-control" placeholder="" name="charge_fixed_booking" id="charge_fixed_booking" value="<?=isset($payment_options) && $payment_options->charge_fixed_booking ? $payment_options->charge_fixed_booking : ''; ?>">
                                          <div class="clearfix"></div>
                                       </div>
                                    </td>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <div class="form-group">
                                          <input type="text" class="form-control" placeholder="" name="charge_service_value" id="charge_service_value" value="<?=isset($payment_options) && $payment_options->charge_service_value ? $payment_options->charge_service_value : ''; ?>">
                                          <div class="clearfix"></div>
                                       </div>
                                    </td>
                  ...
                  <div class="pay  cust-box">
                     ...
                     <div id="collapse3" class="panel-collapse collapse ">
                        <div class="col-md-6 nopadding ">
                           <form class="form-horizontal" id="payment-settings" method="post" action="{{ url('api/payment_settings') }}">
                           <h3>Payment Gateway</h3>
                           <table>
                              <tr>
                                 <td>
                                    <div class="checkbox">
                                       <label class="check"><input type="checkbox" value="paypal" name="paypal" <?=isset($payment_options) && $payment_options->is_enable_paypal=='1' ? 'checked' : ''; ?>> &nbsp;&nbsp; Enable PayPal
                                       <span class="checkmark"></span></label>
                                    </div>
                                 </td>
                                 <td>
                                    <div class="checkbox">
                                       <label class="check"><input type="checkbox" value="stripe" name="stripe" <?=isset($payment_options) && $payment_options->is_enable_stripe=='1' ? 'checked' : ''; ?>> &nbsp;&nbsp; Enable Stripe
                                       <span class="checkmark"></span></label>
                                    </div>
                                 </td>
                              </tr>
                           ...
                           <hr>
                              <div class="form-group">
                                 <input type="text" class="form-control1" placeholder="User Name" name="username" id="username" value="<?=isset($payment_options) && $payment_options->username ? $payment_options->username : ''; ?>">
                                 <div class="clearfix"></div>
                              </div>
                              <button class="butt-save" type="submit">Save</button>
                              <div class="clearfix">&nbsp;</div>
                  ...
                  <div class="pay  cust-box">
                     ...
                     <div id="collapse4" class="panel-collapse collapse ">
                        <div class="">
                           ...
                           <form class="form-horizontal" id="payment-terms" method="post" action="{{ url('api/payment_terms') }}">
                              <div class="row">
                                 <div class="col-md-12 margtop20 ">
                                    <div class="borderbtn">
                                       <label class="">Terms</label>
                                       <div class="cus-textarea col-lg-12" >
                                          <textarea style="width:600px ; height: 150px;" id="area1" name="payment_terms"><?=isset($payment_options) && $payment_options->payment_terms ? $payment_options->payment_terms : ''; ?></textarea>
                                       </div>
                                    </div>
                                 </div>
                              </div>
