               ...
               <div class="prof" style="padding:0;width:100%">
                  <form style="width:50%" action="{{ url('api/change_email') }}" method="post" id="change-email">
                     ...
                     <div class="form-group">
                        ...
                        <div class="profile-email"><?=$user_details->email;?> <span>
                          <a href="javascript:void(0)" id="show-change-email" style="display: none;">change email</a>
                          <a href="javascript:void(0)" id="hide-change-email">change email</a>
                        </span></div>
                     </div>
                     <div id="change-email-inputs" style="display: none;">
                         <div class="form-group">
                            <label for="pwd"><strong>Email:</strong></label>
                            <input type="text" class="form-control" id="email" placeholder="Email" name="email" value="<?=$user_details->email;?>">
                         </div>
