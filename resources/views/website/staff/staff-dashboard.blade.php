         ...
         <div class="upr-rgtsec">
            ...
            <div class="col-md-7">
               <div class="full-rgt">
                  ...
                  <?php
                  if(!empty($staff_data ) && $staff_data->staff_type==1)
                  {
                  ?>
      ...
      <div class="rightpan full" style="width: 100% !important">
        ...
        <div class="modal fade" id="staffFilterModal" role="dialog">
            <div class="modal-dialog add-pop">
                <!-- Modal content--> 
                <div class="modal-content new-modalcustm">
                  <form name="add_appointmentm_form" id="appointmentm_filter_form" method="post" action="{{ url('staff-dashboard') }}" enctype="multipart/form-data">
                      <div class="modal-header">
                         <button type="button" class="close" data-dismiss="modal">×</button>
                      ...
                      <div class="modal-body clr-modalbdy">
                         ...
                         <div class="butt-pop-ft">
                             ...
                             <a href="{{ url('staff-dashboard') }}" class="btn btn-primary butt-next" style="margin-bottom: -20px;">Reset</a> 
                          </div>
                      </div>
                  </form>
                </div>
    ...
    $(function() { 
        ...
        $('#calendar').fullCalendar({
            ...
            eventClick: function(event, element) {
                ...
                $.ajax({
                    url:"<?php echo url('api/staff_appointment_details');?>",
                    type:"POST",
                    data:data,
                    dataType: "json",
        ...
        $(".fc-addButton-button").css("display", "none");
